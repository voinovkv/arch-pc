...
3. Изменяю текст программы и вместо символов, записываю в регистры числа.(рис. @fig:004)
...
![Запуск исполняемого файла](image/5.png){#fig:008 width=70%}
...
![Вывод при замене iprintLF на iprint](image/8.png){#fig:011 width=40%}
...
1. Пишу программу вычисления выражения y=f(x). 
Вариант 18: f(x)=3(x+10)-20.(рис. @fig:018)

![Текст программы](image/18text.png){#fig:018 width=40%}
